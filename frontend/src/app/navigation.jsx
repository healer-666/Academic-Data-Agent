...
export const NAV_ITEMS = [
  { id: "analysis", label: "新建分析", description: "创建任务、检查资料并确认分析方案", icon: Play },
  ...
  { id: "history", label: "历史任务", description: "回看已有任务并继续提问", icon: History },
  { id: "knowledge", label: "本地知识库", description: "管理通用分析使用的本地资料", icon: Database },
