...
def build_run_summary_payload(result: AnalysisRunResult) -> dict[str, object]:
    ...
    return {
        ...
        "interactive_report_manifest_path": result.interactive_report_manifest_path.as_posix() if result.interactive_report_manifest_path else "",
        "interactive_report_snapshot_path": result.interactive_report_snapshot_path.as_posix() if result.interactive_report_snapshot_path else "",
        "interactive_report_source_map_path": result.interactive_report_source_map_path.as_posix() if result.interactive_report_source_map_path else "",
        "interactive_report_summary": dict(result.interactive_report_summary),
