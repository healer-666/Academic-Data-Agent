...
class EventType(str, Enum):
    ...
    EXPERIENCE_LIBRARY_RESOLVED = "experience_library_resolved"
    MODELING_SKILLS_SELECTED = "modeling_skills_selected"
    SEARCH_PLANNING_COMPLETED = "search_planning_completed"
    ...
    FAILURE_MEMORY_RETRIEVAL_STARTED = "failure_memory_retrieval_started"
    FAILURE_MEMORY_RETRIEVAL_COMPLETED = "failure_memory_retrieval_completed"
    FAILURE_MEMORY_RETRIEVAL_SKIPPED = "failure_memory_retrieval_skipped"
    ...
    FAILURE_MEMORY_WRITEBACK_STARTED = "failure_memory_writeback_started"
    FAILURE_MEMORY_WRITEBACK_COMPLETED = "failure_memory_writeback_completed"
    FAILURE_MEMORY_WRITEBACK_SKIPPED = "failure_memory_writeback_skipped"
